...
public class LastChangedByOthers : NubeSyncServerTestBase
{
    [Fact]
...
public class ProcessOperations : NubeSyncServerTestBase
{
    [Fact]
...
public class ProcessOperationsAdd : NubeSyncServerTestBase
{
    [Fact]
...
public class ProcessOperationsModify : NubeSyncServerTestBase
{
    [Fact]
