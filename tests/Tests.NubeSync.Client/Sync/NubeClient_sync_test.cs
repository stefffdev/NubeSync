namespace Tests.NubeSync.Client.Sync;

public class HasPendingOperations : NubeClientTestBase
{
    [Fact]
...
public class PullTable : NubeClientTestBase
{
    public PullTable()
    {
...
public class PushChanges : NubeClientTestBase
{
    [Fact]
    public async Task Adds_authentication_to_the_request_header()
    {
