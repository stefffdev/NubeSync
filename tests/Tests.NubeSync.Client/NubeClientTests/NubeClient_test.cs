...
public class AddTable : NubeClientTestBase
{
    [Fact]
...
public class Always : NubeClientTestBase
{
    ...
    {
        var ex = Assert.Throws<Exception>(() => new global::NubeSync.Client.NubeClient(DataStore, null, Authentication, null, ChangeTracker));
