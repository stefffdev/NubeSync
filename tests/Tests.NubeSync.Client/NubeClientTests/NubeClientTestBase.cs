namespace Tests.NubeSync.Client.NubeClientTests;
...
public class NubeClientTestBase
{
    ...
    public NubeClientTestBase()
    {
        ...
        DataStore.When(x => x.AddOperationsAsync(Arg.Any<NubeOperation[]>())).Do(y => AddedOperations.AddRange(y.Arg<NubeOperation[]>()));
        DataStore.When(x => x.DeleteOperationsAsync(Arg.Any<NubeOperation[]>())).Do(y => RemovedOperations.AddRange(y.Arg<NubeOperation[]>()));
